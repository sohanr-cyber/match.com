...
const TermsAndConditions = () => {
  return (
    <div className={styles.wrapper}>
      <h2>Privacy Policy - Islamic Matrimony Site</h2>
      <div className={styles.items}>
          ...
          <div className={styles.details}>
            {privacyPolicy.informationCollection.map((item, index) => (
              <div style={{ margin: '5px 0' }} key={index}>
                <span style={{ fontWeight: 'bold' }} className={styles.heading}>
                  {item.split(':')[0]}:
                </span>
        ...
        <div className={styles.item}>
          <div className={styles.title}>8. Changes to This Privacy Policy:</div>
          <p className={styles.details}>
